...
class Exp_PatchTST(Exp_Basic):
    ...
    def _forward(self, batch_x, batch_y, batch_x_mark, batch_y_mark):
        return self.model(batch_x, batch_x_mark, batch_y, batch_y_mark)
    ...
    def pretrain(self):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(
                ...
                pred_x = self._forward(batch_x, batch_y, batch_x_mark, batch_y_mark)
    ...
    def test(self):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(
                ...
                preds.append(pred_x.detach().cpu())
