...
# python -u arctandiff_train_diffusion_only_stage2.py \
#     --task_name finetune \
#     --is_training 1 \
#     --root_path $root_path \
#     --data_path "${src_dataset}" \
...
#     --save_directory "arctandiffusion_${src_dataset}_${loss_type}_patch_size_${patch_size}_hidden_size_${hidden_size}_recon_head_${recon_head_depth}_${timestep_sampling}_lr${lr}_${diffusion_loss_type}_sample_same_timesteps_stage2" \
