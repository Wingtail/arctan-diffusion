...
python -u arctandiff_train_diffusion_only.py \
    ...
    --data $data \
    --save_dir "arctandiffusion_eeg_${loss_type}_patch_size_${patch_size}_hidden_size_${hidden_size}_recon_head_${recon_head_depth}_lr${lr}_${diffusion_loss_type}" \
    --features M \
    --input_len $input_len \
    --label_len 0 \
    --pred_len 0 \
...
python -u arctandiff_finetune_classification.py \
    ...
    --model ArcTanDiffusion \
    --data $data \
    --load_dir "arctandiffusion_eeg_${loss_type}_patch_size_${patch_size}_hidden_size_${hidden_size}_recon_head_${recon_head_depth}_lr${lr}_${diffusion_loss_type}" \
    --features M \
    --input_len $input_len \
    --label_len 0 \
    --pred_len $pred_len \
