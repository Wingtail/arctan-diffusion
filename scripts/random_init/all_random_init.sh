...
run_pems_random_init "PEMS03" ""
run_pems_random_init "PEMS04" "0"
run_pems_random_init "PEMS07" "0"
run_pems_random_init "PEMS08" "0"
...
src_dataset="Epilepsy.csv"
model_id="Epilepsy"
data="Epilepsy"
cls_save_tag="epilepsy"
input_len=206
pred_len=4
in_dim=3
patch_size=6
